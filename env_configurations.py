...
def create_animal(num_actors=1):
    ...
    arena_config_in = ArenaConfig('/home/trrrrr/Documents/github/ml/dqn_atari/configs/3-Obstacles.yaml')
    #arena_config_in = ArenaConfig('/home/trrrrr/Documents/github/ml/dqn_atari/configs/1-Food.yaml')
